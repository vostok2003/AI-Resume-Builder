    ...
    <ResumeInfoContext.Provider value={{resumeInfo,setResumeInfo}}>
        <div id="no-print">
            ...
            <div className='my-10 mx-10 md:mx-20 lg:mx-36 ' >
                ...
                <p className='text-center text-gray-400 '>Now you are ready to download your resume and you can share unique resume url with
                ...
                <div className='flex justify-between px-44 my-10'>
                    ...
                    <RWebShare
                        data={{
                        text: "Hello Everyone ! this is my resume please open orl to see",
